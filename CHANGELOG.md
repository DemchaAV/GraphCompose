...
- **A table of contents' labels stay whole in Word.** A row's column sized to its content
  ...
  "Q" to "Appendix A - Pricing schedule" stay on one line. A row with no auto column, or none
  of weight to take the point from, is written as placed.
