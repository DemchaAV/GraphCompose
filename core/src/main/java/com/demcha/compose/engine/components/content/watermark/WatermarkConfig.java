 ...
 *
 * <p>This is a document-level config attached to canonical PDF rendering, not a node
 * in the document tree. The renderer applies it to every page after (or before)
