...
public final class ArabicArticleExample {
    ...
    private static final String CLOSING =
            "ما سبق يصف الفقرة، وخلية الجدول تعلن اتجاهها بنفسها فتُرسم مثلها تماماً: تتصل "
            + "حروفها ويُعاد ترتيبها، ويُقاس عرض العمود على الصورة التي تظهر فعلاً. أما "
            + "الصفوف والقوائم فتتبع اتجاه الفقرة كما في هذه الصفحة.";
