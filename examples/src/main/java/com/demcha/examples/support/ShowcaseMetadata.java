...
final class ShowcaseMetadata {
    ...
    static {
        ...
        cv("cv-runtime-modules-v2", "CvRuntimeModulesExample", "Runtime Modules", "A CV assembled from data rather than written in Java: each section carries the CvKind its author picked, and a category the catalogue has no name for is shaped like any other.", "runtime", "modules");
