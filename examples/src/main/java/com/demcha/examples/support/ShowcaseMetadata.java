...
final class ShowcaseMetadata {
    ...
    private static final String GH_BASE = "https://github.com/DemchaAV/GraphCompose/blob/v2.0.0";
    ...
    static {
        ...
        flagship("twin-output", "TwinOutputExample", "Twin Output", "One 16:9 page written once and emitted twice from the same session - a print-ready PDF and a PowerPoint slide with identical geometry where every shape stays native and editable.", "showcase", "flagship");
