...
/**
 * Pixel-diff visual parity gate for {@link CharcoalGold} - the canonical
 ...
 */
class CharcoalGoldVisualParityTest {
    ...
    void rendersWithinPixelDiffBudget() throws Exception {
        ...
        try (DocumentSession document = GraphCompose.document()
                ...
                .margin(0f, 0f, 0f, 0f)
                .create()) {
            CharcoalGold.create().compose(document, CharcoalGoldFixtures.canonicalCv());
        ...
        PdfVisualRegression.standard()
                ...
                .assertMatchesBaseline("charcoal_gold", pdfBytes);
    }
}
