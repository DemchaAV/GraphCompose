...
/**
 * Shared fixture data for the {@link OrangeOps} gates — the SAME document
 ...
 * versa.
 */
final class OrangeOpsFixtures {

    /** The break a body stacks its lines on. */
    private static final String NEWLINE = String.valueOf((char) 10);

    private OrangeOpsFixtures() {
    }

    /**
     * The canonical one-page CV — four contact items including one link,
     * eleven skills, four achievement cards, a degree, four certifications,
     * the opening prose, three roles, four metrics and four closing lines.
     */
    ...
    static EntriesSection additional() {
