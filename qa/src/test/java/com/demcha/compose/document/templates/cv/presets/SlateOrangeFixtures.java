...
/**
 * Shared fixture data for the {@link SlateOrange} gates — the SAME document
 ...
 * versa.
 */
final class SlateOrangeFixtures {

    /** The break a body stacks its lines on. */
    private static final String NEWLINE = String.valueOf((char) 10);

    private SlateOrangeFixtures() {
    }

    /**
     * The canonical one-page CV — the monogram tile, four contact lines
     * including a link, ten marked competencies, three achievements, three
     * rated languages, three closing facts, a profile, four roles, a degree
     * and four certifications.
     */
    ...
    static ParagraphSection specialisms() {
    ...
    static ParagraphSection profile() {
