...
/**
 * Pixel-diff visual parity gate for {@link TealPulse} — the canonical
...
class TealPulseVisualParityTest {
    ...
    void rendersWithinPixelDiffBudget() throws Exception {
        ...
        try (DocumentSession document = GraphCompose.document().create()) {
            TealPulse.create().compose(document, TealPulseFixtures.canonicalCv());
        ...
        PdfVisualRegression.standard()
                ...
                .assertMatchesBaseline("teal_pulse", pdfBytes);
    }
}
