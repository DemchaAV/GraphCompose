...
/**
 * Pixel-diff visual parity gate for {@link VioletGrid} — the canonical
 ...
 */
class VioletGridVisualParityTest {
    ...
    void rendersWithinPixelDiffBudget() throws Exception {
        ...
        try (DocumentSession document = GraphCompose.document().create()) {
            VioletGrid.create().compose(document, VioletGridFixtures.canonicalCv());
        ...
        PdfVisualRegression.standard()
                ...
                .assertMatchesBaseline("violet_grid", pdfBytes);
    }
}
