...
class ObsidianInvoiceVisualParityTest {
    ...
    void rendersWithinPixelDiffBudget() throws Exception {
        ...
        try (DocumentSession document = GraphCompose.document().create()) {
            ObsidianInvoice.create().compose(document, ObsidianInvoiceFixtures.invoice());
        ...
        PdfVisualRegression.standard()
                ...
                .assertMatchesBaseline("obsidian_invoice", pdfBytes);
    }
}
