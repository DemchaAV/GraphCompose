...
/**
 * Pixel-diff visual parity gate for {@link PaymentsInvoice} — the canonical
...
class PaymentsInvoiceVisualParityTest {
    ...
    void rendersWithinPixelDiffBudget() throws Exception {
        ...
        try (DocumentSession document = GraphCompose.document().create()) {
            PaymentsInvoice.create().compose(document,
        ...
        PdfVisualRegression.standard()
                ...
                .assertMatchesBaseline("payments_invoice", pdfBytes);
    }
}
