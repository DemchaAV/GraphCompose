...
class PlatformInvoiceVisualParityTest {
    ...
    void rendersWithinPixelDiffBudget() throws Exception {
        ...
        try (DocumentSession document = GraphCompose.document().create()) {
            PlatformInvoice.create().compose(document, PlatformInvoiceFixtures.invoice());
        ...
        PdfVisualRegression.standard()
                ...
                .assertMatchesBaseline("platform_invoice", pdfBytes);
    }
}
