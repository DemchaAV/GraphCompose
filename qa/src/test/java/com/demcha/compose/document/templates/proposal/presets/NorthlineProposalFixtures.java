...
/**
 * Shared fixture data for the Northline proposal gates — the SAME spec
 ...
 * {@code StructuredProposalSampleData} — the two modules cannot share a
 * source file, so a content change here belongs there too.</p>
 */
final class NorthlineProposalFixtures {

    private NorthlineProposalFixtures() {
    }
