 ...
 * contains one.</p>
 *
 * <p>Package-private, and here rather than in {@code ..pdf.handlers} for that reason: the
 ...
 * @since 2.4.0
 */
final class PdfLayoutAnchorRenderHandler implements PdfFragmentRenderHandler<LayoutAnchorPayload> {
