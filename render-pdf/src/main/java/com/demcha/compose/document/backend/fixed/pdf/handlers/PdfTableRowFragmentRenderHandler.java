...
public final class PdfTableRowFragmentRenderHandler
    ...
    private List<ResolvedTextLine> resolveTextLines(PdfFont font,
        ...
        // Lines stand a line height and the cell's line spacing apart: the block the layout
        // sized the row for, so the anchor places the text the row was made to hold.
