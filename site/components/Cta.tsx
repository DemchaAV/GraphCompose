        ...
        <Reveal className="cta-grid">
          ...
          <div className="cta-card">
            ...
            <div className="person">
              <span className="name">Artem Demchyshyn</span>
            ...
            <a className="btn" style={{ marginTop: 26, width: "fit-content" }} href="mailto:demchishynartem@gmail.com">Start a conversation</a>
          </div>
