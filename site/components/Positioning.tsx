...
export default function Positioning() {
  return (
    <section className="section" id="positioning">
      <div className="wrap">
        <Reveal>
          <div className="eyebrow">§06 · Positioning</div>
        ...
        {/* Wrap the comparison table so it scrolls horizontally on mobile
            instead of overflowing the 375px viewport (the table needs
            ~1040px to fit all 6 columns without wrapping cells). */}
        <Reveal className="cmp-scroll" style={{ overflowX: "auto", marginTop: 6 }}>
          <table className="cmp">
            <thead>
              <tr>
                <th></th>
