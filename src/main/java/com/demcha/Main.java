...
public class Main {
        ...
        /**
         * Test: Table with 2 columns and 5 rows, centered, with guide lines.
         */
        private static void testTableLayout() throws Exception {
                ...
                try (PdfComposer composer = GraphCompose.pdf(target)
                        ...
                        // Create 5 rows, each with 2 columns
                        ...
                        // Table container (VContainer with all rows)
        ...
        /**
         * Creates a single table row with 2 columns.
         */
        private static Entity createTableRow(com.demcha.compose.loyaut_core.components.ComponentBuilder cb,
        ...
        private static Entity createATableLayout(PdfComposer compose, String name) {
        ...
        private static Entity createASingleObject(PdfComposer compose, String name) {
                var buttons = List.of(
        ...
        private static Entity createButtonsVContainer(PdfComposer compose, String name) {
                var buttons = List.of(
                                button(compose, "Button1"),
                                button(compose, "Button2"));
         ...
         */
        private static Entity createLinksColumn(PdfComposer compose, String name) {
        ...
        private static Entity button(PdfComposer compose, String buttonText) {
                return compose.componentBuilder().button()
                                .text(compose.componentBuilder().text()
                                                .textWithAutoSize(buttonText)
                                                .textStyle(new TextStyle(FontName.DEFAULT, 10, TextDecoration.DEFAULT,
        ...
        static Entity blockTextBuilder(PdfComposer compose, String text, double width, double spacing, String name) {
        ...
        static Entity blockTextBuilder(PdfComposer compose, String text, double width, double spacing) {
