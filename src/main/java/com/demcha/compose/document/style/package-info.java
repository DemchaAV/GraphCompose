/**
 * Public style values for the canonical document DSL.
 *
 * <p>Ownership: public authoring surface. These types should stay small,
 * immutable, and independent from renderer internals.</p>
 *
