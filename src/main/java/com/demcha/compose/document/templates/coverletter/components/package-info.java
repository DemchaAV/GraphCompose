 ...
 *
 * <p>{@link com.demcha.compose.document.templates.coverletter.components.LetterBody}
 ...
 * (via the reused {@code core.text.RichParagraphRenderer}).</p>
 */
package com.demcha.compose.document.templates.coverletter.components;
