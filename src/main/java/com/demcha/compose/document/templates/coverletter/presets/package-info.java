 ...
 * cover-letter presets. They are <em>not</em> the current standard. The
 ...
 * removal in a future major.</p>
 *
 * <p>Each preset shares the typography palette and spacing rhythm
 * of its paired CV preset, so a writer's CV and cover letter ship
 * as a matched set with consistent visual identity.</p>
 *
 * <p>New code should target the layered {@code coverletter.v2} presets
