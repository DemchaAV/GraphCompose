 ...
 *   <li>{@link com.demcha.compose.document.templates.cv.widgets.SectionHeader}
 ...
 *   <li>{@link com.demcha.compose.document.templates.cv.widgets.FlowSectionHeader}
 *       — page-flow-level section headers where rules live outside
 *       the section body.</li>
 *   <li>{@link com.demcha.compose.document.templates.cv.widgets.ProfileBand}
 *       — tinted/ruled summary block with markdown-aware body text.</li>
 *   <li>{@link com.demcha.compose.document.templates.cv.widgets.SectionModule}
 ...
 * in {@code cv/components/} where helpful, but its public face
