...
//import com.demcha.loyaut_core.components.renderable.ChunkedBlockText;
...
//        var style = entity.getComponent(TextStyle.class).orElse(new);
//
...
//        double spaceWidth = style.font().getTextWidth(" ");
//
//        for (String word : words) {
//            double wordWidth = style.font().getTextWidth(word);
//
