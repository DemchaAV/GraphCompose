...
import com.demcha.components.Anchor;
import com.demcha.components.Position;
import com.demcha.components.data.Link;
...
public class RenderEngine {
    ...
    public void measure(com.demcha.layout.Container c, MeasureCtx ctx) {
        if (c.getLayout() == null) throw new IllegalStateException("Container has no layout");
        c.getLayout().measure(c, ctx);
    }

    public void arrange(com.demcha.layout.Container c, ArrangeCtx ctx) {
        if (c.getLayout() == null) throw new IllegalStateException("Container has no layout");
        c.getLayout().arrange(c, ctx);
    }

    public void render(com.demcha.layout.Container c, PdfRenderContext ctx) throws IOException {
