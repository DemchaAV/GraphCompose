...
import com.demcha.compose.engine.utils.TextSanitizer;
...
public class BlockTextBuilder extends EmptyBox<BlockTextBuilder> {
    ...
    private TextIndentStrategy blockStrategy;
    ...
    BlockTextBuilder(EntityManager entityManager, Align align, TextStyle textStyle) {
        ...
        this.blockStrategy = TextIndentStrategy.NONE;
    }
     ...
     * @return this builder
     */
    public BlockTextBuilder strategy(TextIndentStrategy strategy) {
